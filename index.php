...
<section class="contact" id="contact">
    ...
    <div class="row">
        ...
        <form action="">
            ...
            <textarea name="" name="content" class="box" placeholder="Bạn cần gì?" id="" cols="30" rows="10"></textarea>
            <input type="button" class="contact-form btn" value="Gửi tin nhắn">

            <p class="success-contact" style="display:none;color: #fff; font-size: 18px;">Gửi thành công</p>
        </form>
